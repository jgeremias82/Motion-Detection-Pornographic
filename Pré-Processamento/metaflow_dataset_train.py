...
img_out_name = "./dataset_metaflow/porno_flow1.jpg";
...
for item in range(2,247936):
    ...
    img_np1 = "./train/noporno" +  str(item - 1) + ".jpg" ;
    img_p1 = "./train/porno" +  str(item - 1) + ".jpg" ;
	
    img_np2 = "./train/noporno" +  str(item) + ".jpg" ;
    img_p2 = "./train/porno" +  str(item) + ".jpg" ;
    ...
    if(os.path.exists(img_p2)):
        img2_in = img_p2;
	classe = "./dataset_metaflow/porno_flow";
    else:
        img2_in = img_np2;    
	classe = "./dataset_metaflow/noporno_flow";
